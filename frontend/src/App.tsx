...
export default function App() {
  ...
  const speakSentence = async () => {
    if (sentenceRef.current.length === 0 || isSpeaking) return;
      ...
      <div className="main-viewport">
        ...
        <div className="top-overlay glass-overlay">
          ...
          <div className="circular-progress">
             <svg>
                <circle cx="25" cy="25" r="22" fill="none" stroke="transparent" strokeWidth="4" />
                <circle 
                  cx="25" cy="25" r="22" 
                  fill="none" 
                  stroke={progressRatio < 0.5 ? 'var(--cyan)' : 'var(--green)'} 
                  strokeWidth="4"
                  strokeDasharray={`${progressRatio * 138} 138`}
        ...
        <div className="bottom-overlay glass-overlay">
          <div className="sentence-buffer">
             {sentenceBuffer.length > 0 ? (
               ...
               !isSpeaking && <span className="empty-text">Show a gesture to start building a sentence...</span>
             )}
          </div>
